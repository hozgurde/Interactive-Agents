...
public class RecordPlayer : MonoBehaviour
{
    ...
    public BodyIKController TargetBody;
        ...
        if (playNow)
        {
            if (waiting)
            {
                ...
                if (waitTimer <= 0)
                {
                    ...
                    {
                        passportSc
                            .SetCurrentPassportFromRecordPlayer(passes[play_case *
                            2]);
                    }
                    else
                    {
            ...
            if (
                !(
                recordAgent.IsTalkingNow() ||
                (
                aSource != null && aSource.isPlaying ||
                (
                play_experiment == 2 &&
                (recordRight.IsTalkingNow() || recordLeft.IsTalkingNow())
                )
                )
                )
            )
            {
                ...
                if (currentRecord != null)
                {
                    ...
                    Debug
                        .Log("Record: " +
                        currentRecord.recordText +
                        " CaseNo: " +
                        currentRecord.caseNo);
                    if (currentRecord.special != 0)
                    {
                        if (scenarioNo == 1)
                        {
                            ...
                            passportSc.RefreshCSFromRecordPlayer();
                            passportSc
                                .HandlePassportCase(currentRecord.special);
                    ...
                    if (currentRecord.recordIsAgent)
                    {
                        ...
                        int c = int.Parse(currentRecord.recordClip.name[4] + "");
                        //int c = 9;
                        int l =
                            (
                            int.Parse(currentRecord.recordClip.name[7] + "") - 1
                            ) /
                            2;
                        ...
                        TargetHandLeft.c = c;
                        TargetHandLeft.l = l;
                        TargetHandLeft.index = 0;

                        TargetHandRight.c = c;
                        TargetHandRight.l = l;
                        TargetHandRight.index = 0;
                        ...
                        if (play_experiment == 2)
                        {
                            ...
                            {
                                watsonSpeaker
                                    .SpeakFromClip(currentRecord.recordClip,
                                    currentRecord.recordText,
                                    recordLeft);
                                if (onSilentBlack)
                                {
                        ...
                        if (textEmotions)
                        {
                            if (play_experiment == 2)
                            {
                                ...
                                {
                                    recordLeft.e_angry +=
                                        currentRecord.recordEmotion.angry;
                                    recordLeft.e_disgust +=
                                        currentRecord.recordEmotion.disgust;
                                    recordLeft.e_sad +=
                                        currentRecord.recordEmotion.sad;
                                    recordLeft.e_happy +=
                                        currentRecord.recordEmotion.happy;
                                    recordLeft.e_fear +=
                                        currentRecord.recordEmotion.fear;
                                    recordLeft.e_shock +=
                                        currentRecord.recordEmotion.shock;
                                }
                                else
                                {
                                    recordRight.e_angry +=
                                        currentRecord.recordEmotion.angry;
                                    recordRight.e_disgust +=
                                        currentRecord.recordEmotion.disgust;
                                    recordRight.e_sad +=
                                        currentRecord.recordEmotion.sad;
                                    recordRight.e_happy +=
    ...
    {
        saveNamesNLU
            .Add("E" + experimentNo + "_C" + caseNo + "_L" + lineNo + "_S_NLU");
        saveNamesTTS
            .Add("E" + experimentNo + "_C" + caseNo + "_L" + lineNo + "_S_TTS");
        saveTexts.Add (text);
        saveGenders.Add (speakerGender);
        saveOCEANS.Add (speakerOCEAN);
        isAgent.Add(false);

        experiment[experimentNo][caseNo]
            .AddRecord(new OneRecord(text,
                experimentNo,
                lineNo,
                caseNo,
                false));
    ...
    {
        saveNamesNLU
            .Add("E" + experimentNo + "_C" + caseNo + "_L" + lineNo + "_A_NLU");
        saveNamesTTS
            .Add("E" + experimentNo + "_C" + caseNo + "_L" + lineNo + "_A_TTS");
        saveTexts.Add (text);
        ...
        experiment[experimentNo][caseNo]
            .AddRecord(new OneRecord(text, experimentNo, lineNo, caseNo, true));
    ...
    private void SaveRecordSetManual(int number)
    {
        // watsonNLU.GiveForSaving(saveNamesNLU.ToArray(), saveTexts.ToArray());
        watsonSpeaker
            .GiveForSavingManual(saveNamesTTS.ToArray(),
            saveTexts.ToArray(),
            saveOCEANS.ToArray(),
            saveGenders.ToArray(),
            number);
    ...
    private void Set0()
    {
        ...
        SetCase(6);
        AddAgentLine("Nice to meet you. My name is " +
        agentNames[caseNo] +
        ".");
    ...
    private void Set2()
    {
        ...
        AddSpeakerLine("Please buy your return ticket as soon as possible.",
        18);
    ...
    private void Set1()
    {
        ...
        */
        ...
        AddSpeakerLine("What is your occupation?", 14);
        AddAgentLine("No job currently.");
        AddSpeakerLine("Do you have a budget for your expenses and return?",
        17);
        AddAgentLine("Sure, I have.");
        AddSpeakerLine("Please buy your return ticket as soon as possible.",
        18);
        ...
        SetCase(6);
        AddSpeakerLine("Welcome, what is your name?", 99);
        AddAgentLine("Hello, thank you. My name is " +
        agentNames[caseNo] +
        ".");
        AddSpeakerLine("Where have you come from?", 1);
        AddAgentLine("I came from Germany.");
    ...
    private void Set4()
    {
        string burgerListStr =
            "Cheese Burger, Meat Burger, Twin Burger and Chicken Burger";
        SetExperiment(4);

        // O+
        SetCase(0);
        AddSpeakerLine("Hello, what burgers do you sell?");
        AddAgentLine("Our delightful restaurant has " +
        burgerListStr +
        ", which one could I prepare for you?");
        ...
        SetCase(3);
        AddSpeakerLine("Hello, what burgers do you sell?");
        AddAgentLine("Oh, well... We got burgers. We have " +
        burgerListStr +
        ".");
        AddSpeakerLine("Can I get a Cheese Burger?");
        ...
        SetCase(4);
        AddSpeakerLine("Hello, what burgers do you sell?");
        AddAgentLine("My friend, we sell " +
        burgerListStr +
        ...
        SetCase(8);
        AddSpeakerLine("Hello, what burgers do you sell?");
        AddAgentLine("Oh, well, we have fries... Oh, you mean burgers, right? Then it is " +
        burgerListStr +
        ".");
        AddSpeakerLine("Can I get a Cheese Burger?");
    ...
    private void MovCam()
    {
        ...
        if (mov_cam_type == 0)
        {
            mainCam.fieldOfView =
                Mathf
                    .Lerp(mov_body.fieldOfView,
                    mov_face.fieldOfView,
                    mov_cam_lerp);
            mainCam.transform.position =
                Vector3
                    .Lerp(mov_body.transform.position,
                    mov_face.transform.position,
                    mov_cam_lerp);
            mainCam.transform.rotation =
                Quaternion
                    .Slerp(mov_body.transform.rotation,
                    mov_face.transform.rotation,
                    mov_cam_lerp);
        }
        else if (mov_cam_type == 1)
        {
            mainCam.fieldOfView =
                Mathf
                    .Lerp(mov_face.fieldOfView,
                    mov_body.fieldOfView,
                    mov_cam_lerp);
            mainCam.transform.position =
                Vector3
                    .Lerp(mov_face.transform.position,
                    mov_body.transform.position,
                    mov_cam_lerp);
            mainCam.transform.rotation =
                Quaternion
                    .Slerp(mov_face.transform.rotation,
                    mov_body.transform.rotation,
                    mov_cam_lerp);
        }
    }
    ...
    {
        FindObjectOfType<AgentsController>()
        ...
        if (done1 && done2)
        {
            ...
            else
            {
                if (cur > 3)
                {
                    ...
                    if (cam_first)
                    {
                        le_cam_left.gameObject.transform.position =
                            new Vector3(-1.5f, 1.43f, -2.34f);
                        le_cam_right.gameObject.transform.position =
                            new Vector3(-1.5f, 1.43f, -2.34f);
                        le_cam_left.gameObject.transform.rotation =
                            Quaternion.Euler(0f, 22f, 0f);
                        le_cam_right.gameObject.transform.rotation =
                            Quaternion.Euler(0f, 22f, 0f);
                        cam_first = false;
